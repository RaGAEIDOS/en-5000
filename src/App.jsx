...
export default function App(){
  ...
  if(view==="grammar")return(
    <div style={W}><style>{CSS}</style>
      ...
      <p style={{fontSize:13,color:T.m,marginBottom:16,lineHeight:1.6}}>شروحات مفصّلة لكل قاعدة بالعربي المصري — من الأساسيات للقواعد المتقدمة. اضغط على أي موضوع تبدأ تتعلم.</p>
