...
const features = [
  ...
  { icon: '\u{1F9E0}', title: 'تعلم بالذكاء الاصطناعي', desc: 'معلم AI بيفهم مستواك وي Adapt الأسئلة حسب قوتك وضعفك. تعلم بسرعة وكفاءة أعلى.' },
                  ...
                  <li style={{ display: 'flex', alignItems: 'flex-start', gap: '0.8rem', padding: '1rem 1.2rem', background: c.flagItemBg, borderRadius: '14px', border: `1px solid ${c.cardBorder}` }}>
                    ...
                    <div>
                      <strong style={{ color: c.text }}>الفجوة الجيلية واللغات الهجينة</strong>
                       <p style={{ color: c.textSec, fontSize: '0.95rem', lineHeight: 1.9, margin: '0.3rem 0 0' }}>ergo، تزايد الخلط بين العربية واللهجات الدارجة أو اللغات الأجنبية في المحتوى الرقمي يضعف من قوة اللغة العربية المعتمدة.</p>
                    </div>
                  </li>
                </ul>
